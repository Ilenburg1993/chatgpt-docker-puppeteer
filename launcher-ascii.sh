...
#  Audit Level: PM2-First Strategy (Opcao A)
#  Estrategia: Menu interativo + validacoes + health checks + automacoes
...
main_menu() {
    while true; do
        print_header
        echo ""
        echo -e " ${COLOR_GREEN}[1]${COLOR_RESET} Start System          ${COLOR_YELLOW}(boot completo com validacoes)${COLOR_RESET}"
        ...
        echo -e " ${COLOR_GREEN}[9]${COLOR_RESET} Diagnose Crashes      ${COLOR_YELLOW}(analise forense automatica)${COLOR_RESET}"
        echo -e " ${COLOR_GREEN}[10]${COLOR_RESET} Backup Configuration ${COLOR_YELLOW}(snapshot de configs criticos)${COLOR_RESET}"
        echo ""
        ...
        case "$choice" in
            ...
            0) exit 0 ;;
            *)
                echo -e "${COLOR_RED}[ERRO] Opcao inválida!${COLOR_RESET}"
                sleep 2
                ;;
        esac
    done
...
# ============================================================================
#  [1] START SYSTEM - Boot completo com validacoes
# ============================================================================
start_system() {
    clear
...
# ============================================================================
#  [9] DIAGNOSE CRASHES - Análise forense automatica
# ============================================================================
diagnose_crashes() {
    clear
...
# ============================================================================
#  [10] BACKUP CONFIGURATION - Snapshot de configs criticos
# ============================================================================
backup_config() {
    clear
    print_section "BACKUP DE CONFIGURACOES"
    echo ""
