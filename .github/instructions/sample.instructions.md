...
- Configure `strict` no `tsconfig.json` e habilite checagens como `noImplicitAny` e `strictNullChecks`.
...
- Adote convenções de nomenclatura consistentes (camelCase para variáveis/funções, PascalCase para classes/interfaces).
