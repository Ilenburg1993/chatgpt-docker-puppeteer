# Skill: audit-runbook-observability

**Propósito**: Operação diária do pipeline de auditoria: semantic preflight, execução quick/deep/nightly, leitura de artifacts/events/progress e troubleshooting de MCP/RAG/LSP.  
