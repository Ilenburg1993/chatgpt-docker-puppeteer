...
- `audit_mode=observability|architecture|reactive_bug`
- `profile=deep`
...
- Não usar para bugs simples do pipeline de auditoria.
- Não usar como substituto de `audit-system-analysis-planning`.

## Inputs / Preconditions

- planos e tracker do Audit Agent
- referências:
  - `references/client-tag-policy-matrix.md`
  - `references/budget-and-fallback-rules.md`
...
- `audit-system-analysis-planning`
