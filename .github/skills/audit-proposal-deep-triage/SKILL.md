...
Skill especializada para fechar a proposta técnica de um finding crítico. Ela refina causa-raiz,
`suggested_diff`, validação, rollback e framing de risco antes da execução humana.

## Recommended Tuple

- `audit_mode=reactive_bug|security|performance`
- `profile=deep`
- `proposal_depth=deep`
...
- Não usar para a primeira triagem de um bug simples.
- Não usar como skill de descoberta; ele assume um finding já consolidado.

## Inputs / Preconditions

- finding identificado com `bug_id`, arquivo e evidência
- tracker/run_id já definidos
- checklist detalhado em `references/p0-p1-proposal-checklist.md`
