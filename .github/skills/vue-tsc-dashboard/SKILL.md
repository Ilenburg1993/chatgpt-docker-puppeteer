...
description:
  Governa a tipagem do workspace src/dashboard-ui com vue-tsc. Use quando modificar componentes Vue,
  adicionar stores Pinia, tipar configs Vite/Tailwind ou corrigir erros de vue-tsc --noEmit.
license: MIT
---
