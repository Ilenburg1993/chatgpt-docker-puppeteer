...
# shellcheck disable=SC2016 # P_PRE_TOOL_INJECTION usa single quotes intencionalmente: $(cat ...) deve ser literal (fixture de teste de injeção)
P_PRE_TOOL_INJECTION='{"hookEventName":"PreToolUse","sessionId":"itest-s001","timestamp":"2026-06-01T09:52:00Z","tool_name":"run_in_terminal","tool_use_id":"t-inj","tool_input":{"command":"echo $(cat /etc/passwd)","explanation":"inj","goal":"test","isBackground":false},"cwd":"/workspaces/chatgpt-docker-puppeteer"}'P_PRE_TOOL_SAFE='{"hookEventName":"PreToolUse","sessionId":"itest-s001","timestamp":"2026-06-01T09:53:00Z","tool_name":"run_in_terminal","tool_use_id":"t-safe","tool_input":{"command":"echo hello world","explanation":"safe","goal":"echo","isBackground":false},"cwd":"/workspaces/chatgpt-docker-puppeteer"}'
