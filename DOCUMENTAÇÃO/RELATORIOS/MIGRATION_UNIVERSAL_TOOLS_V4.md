...
> **Nota:** relatório de migração concluída (01/02/2026). Use este arquivo como registro técnico;
> valide comandos no baseline atual antes de reutilizar trechos operacionais.
...
3. **Integration Testing** (recommended)
   - Run: `make test-unit` (pre-commit tests)
