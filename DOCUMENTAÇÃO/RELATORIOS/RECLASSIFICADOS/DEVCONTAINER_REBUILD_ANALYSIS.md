...
> **Nota:** análise de rebuild datada. Trate comandos e caminhos como registro do momento auditado e
> valide o baseline canônico antes de reutilizar instruções operacionais.
...
{
  "scripts": {
    "start": "dotenv -e .env -- npx pm2 start ecosystem.config.cjs"
  }
}
```
