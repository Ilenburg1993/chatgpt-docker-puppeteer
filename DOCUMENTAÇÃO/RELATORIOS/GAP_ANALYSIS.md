...
1. **One-command setup**:
   ...
   # Verifica deps, cria dirs, valida Chrome e fluxo de ambiente
   ```
...
- [ ] Fluxo de `bash scripts/setup/setup.sh` completo
- [ ] Criar CLI com Commander.js
- [ ] Melhorar top 10 error messages
- [ ] Consolidar diagnóstico em `bash scripts/health/doctor.sh`
