...
│   ├── PM2 bridge
│   ├── Watchers (fs, logs)
│   └── State persistence (estado.json) — DEPRECATED: usar NERV `SERVER_READY` (ver DOCUMENTAÇÃO/ARQUIVO_MORTO/DEPRECADO/DEPRECATIONS/estado-json-deprecated.md)
│
├── Engine
...
- ✅ State persistence (estado.json para IPC discovery) — DEPRECATED: usar NERV `SERVER_READY` (ver
  DOCUMENTAÇÃO/ARQUIVO_MORTO/DEPRECADO/DEPRECATIONS/estado-json-deprecated.md)
