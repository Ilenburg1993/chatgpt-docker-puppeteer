...
| `typecheck:strict:public` | gate | `tsconfig.strict.public.json` | Public-contract lane files | Exit code only | n/a | Canonical |
...
| `analyze:typing` | audit | `scripts/analysis/typing_hardening_audit.mjs` | Source tree plus strict configs | Console audit | Internal structured JSON in `--format json` mode | Canonical |
| `analyze:typing:public` | audit | `scripts/analysis/typing_hardening_audit.mjs --scope public` | Public-scope files | Console audit | Internal structured JSON in `--format json` mode | Canonical |
| `analyze:tsserver-contract` | drift-check | `scripts/analysis/tsserver_contract_audit.mjs` | Daemon, schema, skill docs | Console audit plus exit code | `schemas/typing/tsserver-tool-contract.schema.json` | Canonical |
