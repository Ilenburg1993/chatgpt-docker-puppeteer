...
> **Nota:** este plano registra a fase inicial de consolidação de 20 de janeiro de 2026. A
> documentação canônica atual já foi promovida para a taxonomia vigente em `DOCUMENTAÇÃO/`; use este
> arquivo como referência histórica de transição, não como baseline operacional.

**Status:** 📦 **HISTÓRICO / SUPERSEDED** - Plano de transição já absorvido pela taxonomia atual
...
- Read [ARCHITECTURE.md](../ARQUITETURA/ARCHITECTURE.md)
- Read [API_REFERENCE.md](../REFERENCIA/API_REFERENCE.md)
