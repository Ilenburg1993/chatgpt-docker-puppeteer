...
- [ ] **Arquivo de inicialização global** (`tests/support/setup.js`)
...
- [ ] **Ajustar scripts npm** para usar o setup:
  ...
  ```json
  "test:unit": "env -u NO_COLOR node --test --test-setup ./tests/support/setup.js 'tests/unit/**/*.spec.js'"
  ```
...
- [ ] **Definir scripts npm unificados** (exemplos abaixo):
  ...
  "scripts": {
    "test:unit": "env -u NO_COLOR node --test --test-setup ./tests/support/setup.js 'tests/unit/**/*.spec.js'",
    "test:integration": "env -u NO_COLOR node --test --test-setup ./tests/support/setup.js 'tests/integration/**/*.spec.js'",
    "test:regression": "env -u NO_COLOR node --test --test-setup ./tests/support/setup.js 'tests/regression/**/*.spec.js'",
...
- [ ] **Timeout global**
  - No `tests/support/setup.js` aplicar `Test.setTimeout(10_000);` ou similar.
