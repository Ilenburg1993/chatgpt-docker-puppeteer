...
- Congelar um baseline observavel do estado atual do projeto, para que cada fase tenha um
  “antes/depois” claro.
...
- [ ] Identificar as “fronteiras” do sistema (HTTP, Socket.io, FS, Puppeteer, PM2, RAG) onde
      `unknown` e JSON entram.
