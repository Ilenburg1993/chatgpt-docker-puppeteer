...
**Data da Auditoria:** 2026-02-13 (Atualizada) **Escopo:** `src/main.js` + `src/server/main.js`
...
1. **Começar com bugs críticos:** Leia
   [LISTA_COMPLETA_BUGS_ATUALIZADA.md](LISTA_COMPLETA_BUGS_ATUALIZADA.md) → Seção "Bugs Críticos
   (P0/P1)"
...
1. **Dashboard de prioridades:** Abra [RESUMO_EXECUTIVO.md](RESUMO_EXECUTIVO.md) → "Dashboard de
   Prioridades"
...
1. **Code smells críticos:** [MELHORIAS_PROPOSTAS.md](MELHORIAS_PROPOSTAS.md) → "Code Smells
...
→ Abra [LISTA_COMPLETA_BUGS_ATUALIZADA.md](LISTA_COMPLETA_BUGS_ATUALIZADA.md) → **BUG-004** (30min,
máximo impacto)
...
- [P1_4_NERV_EMISSION_FIXES_SUMMARY.md](../../P1_4_NERV_EMISSION_FIXES_SUMMARY.md) - Campanha P1-4
  (6 bugs corrigidos)
...
**Última Atualização:** 2026-02-13 **Próxima Revisão:** Após Sprint 1 (2 semanas)
