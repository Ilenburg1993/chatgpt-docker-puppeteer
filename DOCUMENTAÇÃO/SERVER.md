...
Propósito: descrever a camada de entrada HTTP/WebSocket do sistema, como o servidor expõe APIs REST,
adapters Socket.io (real-time) e a ponte com o barramento NERV.
...
- Conexões WebSocket caindo:
  - Verificar limites de conexões do servidor, temporizadores de heartbeat (ping/pong) e consumo de
    CPU/memória. Reiniciar processo se necessário.
