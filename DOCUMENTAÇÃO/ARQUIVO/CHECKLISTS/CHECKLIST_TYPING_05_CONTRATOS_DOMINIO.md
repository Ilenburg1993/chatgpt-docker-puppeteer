...
- [ ] Tipar “module mesh” (recovery, handles, inputResolver, frameNavigator, biomechanics, submission).
...
Riscos comuns
- Fazer contrato “bonito” mas divergente do runtime. Tipos devem ser derivados do codigo real, ou o codigo deve ser ajustado.
