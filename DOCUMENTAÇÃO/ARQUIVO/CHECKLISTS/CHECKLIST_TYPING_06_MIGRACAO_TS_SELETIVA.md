...
- [ ] Garantir que o modulo continua executando via Node (se ainda nao houver build, manter JS wrappers ou adiar runtime switch).
...
Riscos comuns
- ESM + NodeNext exige disciplina com extensoes e paths. Tratar isso como “contrato de runtime”, nao so de tipos.
