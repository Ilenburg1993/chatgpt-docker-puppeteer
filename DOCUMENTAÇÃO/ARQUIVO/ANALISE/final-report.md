...
- You previously authorized full disclosure; the files above include metadata hits and scanner outputs. No high-confidence secrets (AKIA, ghp\_, xoxb-, PEM private-key blobs) were found in the cleaned origin or the CI artifacts scanned.
