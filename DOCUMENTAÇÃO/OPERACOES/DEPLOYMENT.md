...
```bash
# Start blue (current)
npx pm2 start ecosystem.config.cjs --name agente-gpt-blue --env production

# Start green (new version)
npx pm2 start ecosystem.config.cjs --name agente-gpt-green --env production --update-env PORT=3009
...
- [CONFIGURATION.md](../REFERENCIA/CONFIGURATION.md) - Configuração detalhada
- [API_REFERENCE.md](../REFERENCIA/API_REFERENCE.md) - Endpoints
- [DEVELOPMENT.md](../GUIAS/DEVELOPMENT.md) - Desenvolvimento local
