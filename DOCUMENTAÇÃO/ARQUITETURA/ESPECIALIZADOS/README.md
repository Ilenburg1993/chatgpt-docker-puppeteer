...
- [ARQUITETURA_SISTEMA_COMPLETO.md](./ARQUITETURA_SISTEMA_COMPLETO.md)
- [CONNECTION_ORCHESTRATOR.md](./CONNECTION_ORCHESTRATOR.md)
- [RESPONSE_CAPTURE_FLOW.md](./RESPONSE_CAPTURE_FLOW.md)
- [PM2_SOVEREIGN_ARCHITECTURE.md](./PM2_SOVEREIGN_ARCHITECTURE.md)
- [PORT_ARCHITECTURE_ANALYSIS.md](./PORT_ARCHITECTURE_ANALYSIS.md)
- [DNA_SYSTEM.md](./DNA_SYSTEM.md)
- [NERV_REFLECTIONS.MD](./NERV_REFLECTIONS.MD)
- [PATTERNS.md](./PATTERNS.md)
- [PHILOSOPHY.md](./PHILOSOPHY.md)
- [DIAGRAMA_ECOSISTEMA_ASSISTENTES.md](./DIAGRAMA_ECOSISTEMA_ASSISTENTES.md)
