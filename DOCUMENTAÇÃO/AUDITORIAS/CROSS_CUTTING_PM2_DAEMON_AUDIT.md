    ...
    apps: [
        {
            ...
            node_args: '--expose-gc',
            watch: false,
            ignore_watch: ['node_modules', 'logs', 'fila', 'respostas', 'tmp', '*.lock', /* DEPRECATED: estado.json — use NERV SERVER_READY */ 'estado.json', 'src/infra/storage/robot_identity.json'],
        ...
        },
        {
            ...
            script: './src/server/main.js',
            watch: false,
            ignore_watch: ['node_modules', 'logs', /* DEPRECATED: estado.json — use NERV SERVER_READY */ 'estado.json', 'src/infra/storage/robot_identity.json'],
            log_date_format: 'YYYY-MM-DD HH:mm:ss',
