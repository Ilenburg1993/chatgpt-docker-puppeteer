...
- **Ainda em aberto**: backlog P2/P3 restante, com destaque para `GAP-HOOK-01`, `GAP-HOOKS-03`, `GAP-CHAN-02` e `GAP-TERM-03`.
...
| GAP-HOOKS-03 | hooks         | `presets/production.js`            | Audit log misturado com operational log — não-conforme em ambientes regulados                                                     | [09-HOOKS.md](./09-HOOKS.md)                             |
