...
**Data**: 2026-04-12 | **Status**: Levantamento | **Versão**: 1.0
**Scope**: Inventário completo de bugs reais, dívida técnica, features ausentes
**Precedente**: PARTE-23A (diagnóstico), PARTE-22C (roadmap parcial)
...
- **Causa provável**: Migração ESM + mudança de framework de testes (mocha→node:test) sem atualizar specs
...
- **Impacto**: Health-check C2 mostra 0 EventEmitter direto, mas na prática 8 classes emitem localmente sem EventBus
...
- **Realidade**: Apenas 5 arquivos realmente importam de `events/`; 0 emitem via EventBus cross-module
...
- **Severidade**: 🟢 Menor
- **Evidência**: `#copilot/sdk/tools`, `#copilot/sdk/client-facade`, `#copilot/sdk/agents`, `#copilot/hooks/presets/minimal.js`
...
**O código está limpo de markers, mas os problemas reais estão na arquitetura, não em linhas específicas.**
