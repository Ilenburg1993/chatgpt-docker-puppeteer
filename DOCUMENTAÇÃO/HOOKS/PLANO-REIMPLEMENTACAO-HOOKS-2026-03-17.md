...
> **Separacao de responsabilidades**: PreToolUse detecta a _proposta_ (agente exibiu close_key);
> PostToolUse detecta a _resposta_ (usuario digitou a close_key). So o PostToolUse age.
