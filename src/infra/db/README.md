...
**Propósito**: Banco de dados SQLite e repositórios de dados — persiste tarefas, missões,
auditorias, inferências e configurações de usuário.  
**Status**: Canônico.  
**Público**: Módulos que precisam de persistência relacional; mantenedores de schema de banco de
dados.  
...
- Repositórios de tarefas, missões e passos (`task_repo.js`, `task_attempt_repo.js`,
  `mission_repo.js`, `mission_step_repo.js`).
- Repositórios de auditoria (`audit_job_repo.js`, `audit_finding_repo.js`, `audit_patch_repo.js`,
  etc.).
