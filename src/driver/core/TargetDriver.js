...
class TargetDriver extends EventEmitter {
  ...
  ========================================================================== */
    ...
    async prepareContext(_taskSpec) {
        throw new Error('Método prepareContext não implementado.');
    }
    async sendPrompt(_text, _taskId, _signal) {
        throw new Error('Método sendPrompt não implementado.');
    }
    async waitForCompletion(_startSnapshot, _signal) {
        throw new Error('Método waitForCompletion não implementado.');
    }
    async captureState() {
        throw new Error('Método captureState não implementado.');
    }
    async stopGeneration() {
        throw new Error('Método stopGeneration não implementado.');
    }
