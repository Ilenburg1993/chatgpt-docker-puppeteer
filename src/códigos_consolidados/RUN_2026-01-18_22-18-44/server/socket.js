FILE_ORIGINAL: D:\chatgpt-docker-puppeteer\src\server\engine\socket.js
PASTA_BASE: server
...
/* ==========================================================================
   ...
   Sincronizado com: shared/ipc/schemas.js V410, constants.js V400,
                     ipc_client.js V600.
========================================================================== */
...
const { validateRobotIdentity, validateIPCEnvelope } = require('../../shared/ipc/schemas');
const { PROTOCOL_VERSION, IPCActor } = require('../../shared/ipc/constants');
 ...
 * 
 * @param {string} command - Constante IPCCommand (ex: ENGINE_PAUSE).
