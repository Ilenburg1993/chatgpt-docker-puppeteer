FILE_ORIGINAL: D:\chatgpt-docker-puppeteer\src\server\supervisor\reconcilier.js
PASTA_BASE: server
...
/* ==========================================================================
   ...
   Sincronizado com: engine/socket.js V600, remediation.js V600, 
                     shared/ipc/constants.js V400.
========================================================================== */

const socketHub = require('../engine/socket');
const remediation = require('./remediation');
const { log } = require('../../../core/logger');
const { IPCCommand, IPCEvent } = require('../../../shared/ipc/constants');
...
class SupervisorReconciler {
    ...
    _attachSensoryListeners() {
        ...
        io.on('connection', (socket) => {
            socket.on('message', (envelope) => {
                if (envelope.kind === IPCEvent.STALL_DETECTED) {
    ...
    _attemptEmergencyPing(robotId) {
        socketHub.sendCommand(IPCCommand.ENGINE_RESUME, { 
