...
**Propósito**: Definições de tipos TypeScript/JSDoc para todos os domínios do sistema —
augmentações, contratos e tipos globais.  
**Status**: Canônico.  
...
- Augmentações de tipos por domínio (`core/`, `driver/`, `infra/`, `kernel/`, `logic/`, `missions/`,
