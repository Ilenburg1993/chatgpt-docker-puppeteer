<template>
  <div class="p-6">
    <div class="flex items-center gap-4 mb-6">
      <router-link to="/audit" class="text-blue-600 hover:text-blue-800">
        ← Voltar ao Painel
      </router-link>
    </div>
    ...
    <div v-else-if="activeTab === 'backends'">
      <div class="bg-white rounded-lg shadow overflow-hidden">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="backend in backends" :key="backend.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span :class="backend.enabled ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'" class="px-2 py-1 text-xs rounded">
        ...
        <div v-if="backends.length === 0" class="text-center py-8 text-gray-500">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="model in models" :key="model.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span :class="model.enabled ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'" class="px-2 py-1 text-xs rounded">
