<template>
    <div class="p-6">
        <div class="flex items-center gap-4 mb-6">
            <router-link to="/audit/jobs" class="text-blue-600 hover:text-blue-800"> ← Voltar aos Jobs </router-link>
        </div>
        ...
        <div v-else-if="patch">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="mt-4 text-sm text-gray-500">Criado em: {{ formatDate(patch.created_at) }}</div>
            </div>
            ...
            <div v-if="applyReadiness" class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <span
                            :class="applyReadiness.will_execute_real_apply ? 'text-green-600' : 'text-red-600'"
                            class="ml-2"
                        >
