...
<template>
    ...
    >
        <div
            class="absolute inset-0 bg-gradient-to-br from-blue-600/5 via-transparent to-violet-600/5 pointer-events-none"
        ></div>
        ...
        <div class="flex-1 overflow-y-auto scrollbar-thin py-6 relative">
            <nav class="space-y-2 px-3">
                ...
                >
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/5 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"
                    ></div>
                    <component
                        :is="item.icon"
                        :size="22"
                    ...
                    />
                    <span v-if="!collapsed" class="text-sm font-semibold tracking-wide transition-all duration-300">
                        {{ item.label }}
                    </span>
                    <div
