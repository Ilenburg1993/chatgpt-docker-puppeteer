...
**Propósito**: Integrações com ferramentas e serviços externos — LSP, MCP e ferramentas de IA (RAG,
Ollama, LSP tools).  
...
- Classificador de erros e circuit breaker Ollama (`error-classifier.mjs`,
