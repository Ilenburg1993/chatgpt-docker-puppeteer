...
/**
 * Schema Zod para validação de tarefas (versão atual).
 * Define estrutura e regras para objetos de tarefa válidos.
 */
export const TaskSchema = schemaCore.TaskSchema;

/**
 * Schema Zod para validação de DNA de missão.
 * Define estrutura e regras para configurações de DNA.
 */
...
/**
 * Módulo core de schemas para acesso avançado.
 * Contém funções utilitárias e schemas internos.
 */
