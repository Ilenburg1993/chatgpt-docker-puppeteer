...
/**
 * Parseia e valida uma tarefa raw, aplicando migração automática V4 → V5 se necessário. Side-effects: Validação
 * rigorosa, migração transparente de versões antigas.
 *
