...
/**
 * Trunca texto respeitando pontos finais, interrogações e quebras de linha. Busca um corte natural no final de uma
 * sentença ao invés de truncar no meio de uma palavra.
 *
 * **Estratégia de corte**:
 *
 ...
 * @param {number} [limit=2000] - Limite máximo de caracteres. Default is `2000`
