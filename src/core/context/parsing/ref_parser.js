...
/**
 * Varre o texto em busca de referências {{REF:...}} e retorna uma lista de objetos de intenção. Padrão suportado:
 * {{REF:CRITERIA|TRANSFORM}} ou {{REF:CRITERIA}}
 *
 ...
 * @returns {{ fullMatch: string; criteria: string; transform: string }[]} Lista de referências extraídas
 */
