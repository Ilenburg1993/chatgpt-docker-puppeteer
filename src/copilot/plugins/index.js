 ...
 *
 * Este módulo é **L3** — mesmo nível de hooks, tools e bridges.
 * Plugins podem integrar-se com tools, hooks e bridges via DI container.
 *
 ...
 * @property {(container: import('../core/di.js').Container) => void | Promise<void>} install - Função de instalação que recebe o container DI.
 */
