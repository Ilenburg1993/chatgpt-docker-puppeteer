...
- [x] 2026-06-05: `/byok gateway limits` e `/byok gateway quota-matrix` migraram de ANSI hardcoded para rows temáticas; o `diagnostic-ux-cycle` agora cobre as duas telas e PASS em `artifacts/terminal-live/2026-06-05T12-37-14-181Z/summary.md`.
- [x] 2026-06-05: painéis BYOK de limites/quotas passaram a traduzir frescor, janelas, fontes, capacidades e ações pré-runtime, removendo tokens como `key_credit_balance`, `not_blocking` e paths absolutos do catálogo; live `diagnostic-ux-cycle` PASS em `artifacts/terminal-live/2026-06-05T12-43-46-827Z/summary.md`.
- [x] 2026-06-05: `/byok gateway accounts` entrou no mesmo padrão temático de pré-runtime, com source IDs humanizados (`conta OpenRouter`) e cobertura live junto de `limits`/`quota-matrix`; live PASS em `artifacts/terminal-live/2026-06-05T12-48-56-181Z/summary.md`.
- [x] 2026-06-05: `/byok gateway overlays` foi renomeado e renderizado como `BYOK overlays de conta`, com catálogo relativo, source IDs humanos, redaction status traduzido e cobertura no `diagnostic-ux-cycle`; live PASS em `artifacts/terminal-live/2026-06-05T12-53-21-186Z/summary.md`.
- [x] 2026-06-05: `/byok gateway routes` migrou para `BYOK rotas do gateway`, sem ANSI/título inglês, com labels humanos de seleção/política e janela default reduzida para 12 rotas; live PASS em `artifacts/terminal-live/2026-06-05T12-58-02-768Z/summary.md`.
