...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `WORKSPACE_LLMB_MCP_TASKGROUP_READINESS_AUDITORIA_PROFUNDA_ESTADO_ATUAL_ESTADO_ALVO_ROADMAP_2026-08-26.md`                                                                            | **CANÔNICO / ATIVO ESPECIALIZADO**     | autoridade atual para `llmb_live_readiness`, cancellation/drain, workers/redaction, memória, cache, SQLite retention e incidente host `TaskGroup` |
| `WORKSPACE_MCP_AURELIN_4_CONEXAO_RECONEXAO_OAUTH_2026_AUDITORIA_ESTADO_ALVO_ROADMAP_2026-08-25.md`                                                                                    | **CANÔNICO / ATIVO ESPECIALIZADO**     | autoridade atual para AURELIN 4, conexão/reconexão, OAuth/CIMD, MCP 2026, subscriptions, descriptor observation e boundary Refresh do ChatGPT     |
