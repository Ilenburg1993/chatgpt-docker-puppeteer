...
- [ ] Próximo passo: auditar `dialog/engine.js`, `dialog/output.js` e eventos de sessão por mensagens manuais de espera/erro, especialmente retomada, timeout, empty turn, prompt preservado e request_user_input.
