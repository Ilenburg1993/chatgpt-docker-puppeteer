...
- [ ] Próximo passo: sair do `/byok` e auditar outras superfícies do terminal com ANSI/manual layout: status inline, event log residual, request_user_input e harness live LLM-B.
