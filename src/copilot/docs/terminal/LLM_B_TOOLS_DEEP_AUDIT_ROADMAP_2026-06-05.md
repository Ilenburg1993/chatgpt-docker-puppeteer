...
- [ ] Próximo passo: auditar `/byok gateway commands`, `prebuild`, `catalog refresh/diff/integrity` para priorizar as superfícies pré-build mais usadas e eliminar ANSI manual por ondas, sem reescrever todo o `/byok` legado de uma vez.
