...
- [ ] Próximo passo: auditar `catalog refresh/diff/integrity` e `selection audit` para priorizar as superfícies pré-build com maior volume de logs/progresso e eliminar ANSI manual por ondas, sem reescrever todo o `/byok` legado de uma vez.
