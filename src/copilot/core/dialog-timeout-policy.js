// @ts-check
/**
 * @module copilot/core/dialog-timeout-policy
 * @file Política pura e compartilhada de timeout adaptativo para diálogo/inject/transporte.
 *
 *   Vive em `core` porque é regra algorítmica reutilizada por `presentation`, `terminal` e `channel` sem depender da
