...
const SECRET_VALUE_RE =
    /\b(?:sk|sk-or-v1|gsk|hf|csk|nvapi|cpk|cfat|AIza|ya29|xoxb|pat|ghp)[A-Za-z0-9._~+/=-]{8,}\b/gu;
const SECRET_ASSIGNMENT_RE =
    /((?:api[_-]?key|authorization|bearer[_-]?token|token|secret|password)\s*[:=]\s*["']?)[^"',\s;]{8,}/giu;
const SENSITIVE_KEY_RE = /api[_-]?key|authorization|bearer|token|secret|password/iu;
