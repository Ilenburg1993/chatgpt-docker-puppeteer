...
export const SDK_LAYER_ACCESS_POLICY = Object.freeze([
    ...
    {
        layer: 'boot',
        preferred: ['#copilot/sdk/session', '#copilot/sdk/telemetry'],
    ...
    },
    {
        ...
        allowed: [],
        discouraged: ['#copilot/sdk/rpc/experimental'],
        notes: 'O adapter server/routes/sdk pode compor session/RPC/tools/telemetry/models por subpaths exatos.',
    },
    {
        layer: 'terminal',
        preferred: ['#copilot/sdk/session', '#copilot/sdk/rpc', '#copilot/sdk/models', '#copilot/sdk/tools'],
        allowed: [],
        discouraged: ['#copilot/sdk/rpc/experimental'],
        notes: 'O gateway terminal pode projetar sessão, modelos e tools por subpaths exatos; demais terminal modules não devem tocar SDK cru.',
    },
    {
        layer: 'tools',
    ...
    {
        layer: 'events',
        preferred: ['#copilot/sdk/session', '#copilot/sdk/models'],
        allowed: [],
        discouraged: ['#copilot/sdk/rpc/experimental'],
        notes: 'Eventos SDK nascem de session e podem projetar metadados do registry de modelos por subpath exato.',
    },
    {
        layer: 'types',
        preferred: ['#copilot/sdk/types'],
        allowed: [],
        discouraged: ['#copilot/sdk/rpc/experimental'],
