...
export const EMITTER_SESSION_AUTOPILOT_OBJECTIVE_CHANGED = 'session.autopilot_objective_changed';
export const EMITTER_SESSION_CUSTOM_AGENTS_UPDATED = 'session.custom_agents_updated';
export const EMITTER_SESSION_CUSTOM_NOTIFICATION = 'session.custom_notification';
export const EMITTER_SESSION_EXTENSIONS_ATTACHMENTS_PUSHED = 'session.extensions.attachments_pushed';
export const EMITTER_SESSION_REMOTE_STEERABLE_CHANGED = 'session.remote_steerable_changed';
export const EMITTER_SESSION_SCHEDULE_CREATED = 'session.schedule_created';
export const EMITTER_SESSION_SCHEDULE_CANCELLED = 'session.schedule_cancelled';
export const EMITTER_EXTENSION_CONTEXT = 'extension_context';
export const EMITTER_NEW_INBOX_MESSAGE = 'new_inbox_message';
export const EMITTER_SESSION_USAGE = 'session.usage';
export const EMITTER_LLM_USAGE = 'llm.usage';
export const EMITTER_SESSION_USAGE_CHECKPOINT = 'session.usage_checkpoint';
export const EMITTER_SESSION_LIMITS_CHANGED = 'session.limits_changed';
export const EMITTER_SESSION_LIMITS_EXHAUSTED_REQUESTED = 'session.limits_exhausted.requested';
export const EMITTER_SESSION_LIMITS_EXHAUSTED_COMPLETED = 'session.limits_exhausted.completed';
