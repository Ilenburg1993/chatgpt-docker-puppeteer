 ...
 *
 * @deprecated Faixa 3.4 (D3-02): use `new EventEmitter()` de `'node:events'` diretamente. Será removido numa próxima
 *   faixa de cleanup.
 ...
 *
 * @deprecated Faixa 3.4 (D3-02): use `import { EventEmitter } from 'node:events'` diretamente. Será removido numa
 *   próxima faixa de cleanup.
 */
