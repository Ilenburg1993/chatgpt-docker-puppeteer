// @ts-check
/**
 * src/copilot/channel/protocol/structured-message.js
 *
 * @module copilot/channel/protocol/structured-message
 * @see EventBus
 */
...
export function parseStructuredResponse(raw) {
    ...
    // Estratégia 4: objetos JSON balanceados embutidos em texto.
    // O scanner respeita strings/escapes e avalia cada objeto isoladamente; nunca concatena objetos vizinhos.
...
/**
 * Extrai objetos JSON top-level balanceados de texto arbitrário, respeitando strings e escapes.
 * Objetos aninhados permanecem dentro do candidato top-level e braces em strings não alteram a profundidade.
 *
 * @param {string} text
 * @returns {string[]}
 */
