 ...
 *
 * A instância do namespace é injetada por `server/socket/hub-ns.js` após a montagem,
 * invertendo a dependência: server → conversation-hub (direção correta).
 *
...
/**
 * Injeta a instância do namespace Socket.IO.
 * Chamado por `server/socket/hub-ns.js::mountCopilotNamespace()` após criação do namespace.
 *
