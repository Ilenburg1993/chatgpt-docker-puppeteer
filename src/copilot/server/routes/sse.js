 ...
 *   GET /events/critical — stream SSE filtrado: somente eventos críticos (CRITICAL_EVENTS)
 *
...
export function createSseRouter() {
     ...
     *
     * Headers gerenciados pelo createSseWriter:
    ...
    /**
     * Stream SSE filtrado: somente eventos do set CRITICAL_EVENTS
     * (`dialog.stalled`, `fatal`, `system`).
     *
