 ...
 * @property {import('../sdk-config-port.js').SectionOverrideAction} action
 ...
 *
 * @type {Record<string, { CONTENT: string; ACTION: import('../sdk-config-port.js').SectionOverrideAction }>}
 */
const SECTIONS = {
    identity,
    tone,
