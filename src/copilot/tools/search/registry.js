 ...
 *
 * Este módulo é o único dono da montagem de `searchTools` e `symbolSearchTools`.
 * Separado de `index.js` para preservar a invariante barrel-only nesse arquivo.
 *
...
/**
 * Conjunto completo de search tools para registro no bootstrap com category 'search'.
 * `searchInFilesTool` sem skip; os demais com skip de permissão para uso interno.
 * @type {import('#copilot/sdk/types').Tool<any>[]}
 */
