...
function modelEvidenceValues(row) {
    ...
    const values = [
        ...
        { fieldPath: 'capabilities.no_remote_secrets', value: true },
        ...Object.entries(modalities).map(([key, value]) => ({ fieldPath: `modalities.${key}`, value })),
        { fieldPath: 'providerMetadata.ownedBy', value: 'local' },
        { fieldPath: 'providerMetadata.runtimeKind', value: 'local' },
        { fieldPath: 'providerMetadata.localPrivate', value: true },
