...
export const MODEL_GATEWAY_CANONICAL_COMMANDS = Object.freeze([
    ...
    },
    {
        ...
        phase: 'automation',
        surface: 'package',
        command: 'npm run model-gateway:auto:status',
        summary: 'Build the pure runtime automation decision without provider calls or terminal mutation.',
    },
    {
        id: 'automation.plan',
        phase: 'automation',
        surface: 'package',
        command: 'npm run model-gateway:auto:plan -- --profile=repo_agent',
    ...
    },
    {
        ...
        phase: 'automation',
        surface: 'package',
        command: 'npm run model-gateway:auto:explain',
        summary: 'Combine automation status and doctor into one read-only explanation.',
    },
    {
        id: 'automation.handoffs',
        phase: 'automation',
        surface: 'package',
        command: 'npm run model-gateway:auto:handoffs',
        summary: 'Read persisted SDK session handoffs created by model-gateway automation.',
    },
    {
        id: 'automation.confirmations',
        phase: 'automation',
        surface: 'package',
        command: 'npm run model-gateway:auto:confirmations',
    ...
    },
    {
        ...
        phase: 'automation',
        surface: 'make',
        command: 'make model-gateway-auto-status',
        summary: 'Makefile alias for the no-mutation runtime automation decision.',
    },
    {
        id: 'make.auto-plan',
        phase: 'automation',
        surface: 'make',
        command: 'make model-gateway-auto-plan',
    ...
    {
        id: 'make.auto-explain',
        phase: 'automation',
        surface: 'make',
        command: 'make model-gateway-auto-explain',
        summary: 'Makefile alias for the read-only terminal auto explanation.',
    },
    {
        id: 'make.auto-handoffs',
        phase: 'automation',
        surface: 'make',
        command: 'make model-gateway-auto-handoffs',
        summary: 'Makefile alias for persisted SDK session handoffs.',
    },
    {
        id: 'make.auto-confirmations',
        phase: 'automation',
        surface: 'make',
    ...
    },
    {
        ...
        phase: 'automation',
        surface: 'terminal',
        command: '/byok auto on profile:repo_agent',
        summary: 'Enable the default auto_same_boundary persistent policy for the next boot without provider calls.',
    },
    {
        id: 'terminal.auto-on-guarded',
        phase: 'automation',
        surface: 'terminal',
        command: '/byok auto on profile:repo_agent preset:llm_operator_guarded',
