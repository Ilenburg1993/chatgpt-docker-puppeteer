 ...
 *
 * This barrel intentionally exposes only stable contracts and projections. Runtime bridges should depend on this
 * module, while `src/copilot/sdk` remains the thin GitHub Copilot SDK boundary.
 *
