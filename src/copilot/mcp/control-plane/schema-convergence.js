 ...
 * the control plane avoids a server -> registry -> tools -> server dependency cycle and makes convergence observable
 * without assuming that a server restart forces a client-side schema refresh.
 *
 * @module copilot/mcp/control-plane/schema-convergence
 */
