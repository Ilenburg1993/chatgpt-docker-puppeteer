 ...
 *
 * @module copilot/mcp/diagnostics/latency/openai/latency
 */
...
const OPENAI_ENDPOINT_LATENCY_HISTORY_IO = createConfiguredFsIo(
    createConfiguredFsGrant({
        id: 'mcp.diagnostics.latency.openai-endpoint',
...
export async function appendOpenAiEndpointLatencySnapshot(snapshot, options = {}) {
    ...
    try {
        ...
        return {
            persisted: true,
            path: toMcpWorkspaceRelativePath(OPENAI_ENDPOINT_LATENCY_HISTORY_PATH),
            maxSnapshots,
