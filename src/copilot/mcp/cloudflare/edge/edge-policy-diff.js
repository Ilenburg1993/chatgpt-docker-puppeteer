...
export async function diffCloudflareEdgePolicy(options = {}) {
    ...
    return buildEdgePolicyDiff(actual, desired, { env: resolveCloudflareEnvironment(options) });
}
...
export function buildEdgePolicyDiff(actual, desired, options = {}) {
    const originAnonymousRateLimit = readOriginAnonymousMcpRateLimitPolicy(options.env ?? {});
