 ...
 */
export async function readCloudflaredMetricsSnapshot(options, config) {
    if (!config) throw new TypeError('Cloudflared metrics snapshot requires a Cloudflare config projection.');
