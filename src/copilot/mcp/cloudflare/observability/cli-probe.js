 ...
 * @returns {string | null}
 */
export function readSmokeBearerToken(env) {
    if (!env) throw new TypeError('Smoke bearer-token parsing requires explicit env.');
 ...
 * @returns {number}
 */
export function readPositiveIntegerEnv(env, name, fallback) {
 ...
 * @returns {boolean}
 */
export function readBooleanEnv(env, name, fallback = false) {
