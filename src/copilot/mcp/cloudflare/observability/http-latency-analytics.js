...
import { getCloudflareClient, readCloudflareRemoteApiConfig } from '../remote/public/runtime.js';
...
/**
 * @param {{ windowMinutes?: number; timeoutMs?: number; forceRefresh?: boolean; authority?: import('../environment-authority.js').CloudflareEnvironmentAuthority; env?: NodeJS.ProcessEnv }} [options]
