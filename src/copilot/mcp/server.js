...
export const COPILOT_MCP_PROTOCOL_VERSION = '2025-11-25';
...
/** @type {Readonly<import('@modelcontextprotocol/sdk/types.js').Implementation>} */
 ...
 * @property {Readonly<import('@modelcontextprotocol/sdk/types.js').Implementation>} serverInfo
 ...
 *
 * @param {{ toolSurfacePolicy?: import('./tool-surface.js').McpToolSurfacePolicy }} [options]
 ...
 * @returns {Readonly<import('@modelcontextprotocol/sdk/types.js').Implementation>}
 */
function buildCopilotMcpServerInfo(policy) {
    ...
    return Object.freeze(/** @type {import('@modelcontextprotocol/sdk/types.js').Implementation} */ (info));
}
