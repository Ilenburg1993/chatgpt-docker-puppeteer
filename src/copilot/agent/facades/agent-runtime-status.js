 ...
 *
 * O cast protege consumers contra mudanças internas no typedef de `AgentStatusSnapshot` sem perder checagem nos pontos
 * que extraem campos concretos.
 *
 ...
 *
 * Runtimes compat ou mocks antigos podem não implementar `getHealthSnapshot()`, por isso `null` é parte do contrato.
 *
 * @param {AlwaysAliveAgentLike} agent
