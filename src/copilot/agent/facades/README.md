...
`sdk-access.js` permanece como **façade pública canônica** para callers do runtime; a pasta `sdk/`
existe para evitar monólito interno, não para reabrir bypasses arbitrários.
