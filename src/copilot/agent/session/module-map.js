...
export const SESSION_MODULE_LAYOUT = Object.freeze([
    ...
    },
    {
        ...
        tier: 'secondary',
        public: false,
        summary: 'Barrel puro das capacidades de boot.',
    },
    {
        path: 'boot/steps/index.js',
        role: 'boot',
        tier: 'internal',
        public: false,
        summary: 'Barrel puro das steps de boot.',
    },
    {
    ...
    },
    {
        ...
        tier: 'secondary',
        public: false,
        summary: 'Barrel puro de histórico de sessão.',
    },
    {
        path: 'initializers/index.js',
        role: 'initializer',
        tier: 'secondary',
        public: false,
        summary: 'Barrel puro dos inicializadores de sessão.',
    },
    {
        ...
        tier: 'secondary',
        public: false,
        summary: 'Barrel puro do lifecycle de sessão.',
    },
    {
        path: 'state/index.js',
        role: 'state',
        tier: 'secondary',
        public: false,
        summary: 'Barrel puro do estado de sessão.',
    },
    {
        path: 'state/store/index.js',
        role: 'state',
        tier: 'internal',
        public: false,
        summary: 'Barrel puro do store físico de snapshots.',
    },
    {
        ...
        tier: 'secondary',
        public: false,
        summary: 'Barrel puro do wiring de sessão.',
    },
    {
