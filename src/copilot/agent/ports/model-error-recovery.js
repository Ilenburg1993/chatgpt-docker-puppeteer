 ...
 *
 * A politica canonica vive em `sdk/errors.js`, pois descreve semantica de erro do SDK e tambem e usada por `hooks/`
 * sem abrir dependencia ascendente para `agent/`.
 *
