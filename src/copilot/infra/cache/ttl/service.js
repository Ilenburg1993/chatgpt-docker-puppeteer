// @ts-check
/**
 * Small process-local in-memory TTL cache with in-flight de-duplication.
 *
 * The cache is bounded and dependency-free. It is appropriate for short-lived diagnostics, metadata fetches and other
 * idempotent read paths where repeated calls happen in bursts. It must not be used for authorization decisions that
 * require immediate revocation unless the caller chooses a suitably tiny TTL or force-refreshes.
 *
 * @module copilot/infra/cache/ttl/service
 */
