 ...
 * @typedef {{get:(key:string)=>IoCacheEntry|null;getVerified:(key:string,filePath:string)=>Promise<IoCacheEntry|null>;set:(key:string,entry:IoCacheEntry)=>void;invalidate:(filePath:string,options?:{recursive?:boolean})=>void;stats:()=>IoCacheStats;clear:()=>void}} IoL1Cache
 */
export {};
