...
import { CROSS_PROCESS_INVALIDATION_TABLE, ensureJournalSchema } from './store.js';
import { normalizeNonNegativeInteger, readSequence, readSequenceValue } from './utils.js';
...
export function readCrossProcessInvalidationReplay(options = {}) {
    ...
    try {
        const db = options.db ?? getInfraSqliteDatabase();
