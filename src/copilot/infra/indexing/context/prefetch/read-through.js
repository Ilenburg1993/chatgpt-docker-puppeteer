...
import { getVerifiedIoL1Entry, makeBytesKey, makeTextKey, normalizeIoCacheKey } from '#copilot/infra/internal/cache';
...
import { getIoIndex } from '#copilot/infra/internal/indexing/registry';
import { sha256, toOwnedBuffer } from '#copilot/infra/internal/platform';
import { stat as fsStat } from 'node:fs/promises';
import * as nodePath from 'node:path';
import { primeIoL1Entry, warmCacheForPaths } from './cache-warm.js';
