// @ts-check
/**
 * Canonical application SQLite migration ledger.
 *
 ...
 *
 * @module copilot/infra/database/sqlite/application/migrations
 * @see EventBus
...
import { MODEL_GATEWAY_SQLITE_SCHEMA_SQL } from './model-gateway-schema/index.js';
 ...
 * @property {(db: import('#copilot/infra/internal/database/port').SqliteDatabasePort) => void} [upFn] - Alternativa imperativa
 */
