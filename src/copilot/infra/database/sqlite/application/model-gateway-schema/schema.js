 ...
 *
 * The physical schema belongs to Infra persistence; Model Gateway consumes and re-exports the schema contract without
 * owning database mechanics or forcing Infra to depend upward on the domain.
 *
...
export const MODEL_GATEWAY_SQLITE_SCHEMA_SQL = `
    ...
    CREATE INDEX IF NOT EXISTS idx_mg_automation_effects_decision
