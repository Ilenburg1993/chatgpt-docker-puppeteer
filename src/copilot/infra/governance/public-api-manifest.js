...
const PUBLIC_API_AUTHORITY = Object.freeze({
    ...
    '#copilot/infra/public/composition/database/sqlite/path': authority('configured-bound', true),
    ...
    '#copilot/infra/public/indexing/graph': authority('none'),
    '#copilot/infra/public/indexing/module-resolution': authority('workspace-bound', true),
    ...
    '#copilot/infra/public/process/execution': authority('none'),
    '#copilot/infra/public/process/supervision': authority('none'),
...
export const INFRA_PUBLIC_API_MANIFEST = Object.freeze([
    ...
    definePublicApi({
        ...
        target: './src/copilot/infra/public/composition/database/sqlite/path/index.js',
        audience: 'composition',
        privilege: 'authority',
        stability: 'stable',
        lifecycle: 'none',
        costTier: 'micro',
        exports: ['resolveApplicationSqlitePath'],
    }),
    definePublicApi({
    ...
    definePublicApi({
        ...
        target: './src/copilot/infra/public/indexing/graph/index.js',
        audience: 'runtime',
        privilege: 'pure',
        stability: 'experimental',
        lifecycle: 'none',
    ...
    definePublicApi({
        ...
        target: './src/copilot/infra/public/indexing/module-resolution/index.js',
        audience: 'runtime',
        privilege: 'read',
        stability: 'experimental',
        lifecycle: 'none',
    ...
    definePublicApi({
        ...
        target: './src/copilot/infra/public/process/execution/index.js',
        audience: 'runtime',
        privilege: 'authority',
        stability: 'stable',
        lifecycle: 'none',
        costTier: 'standard',
        exports: [
            'DEFAULT_BUFFERED_PROCESS_MAX_BYTES',
            'DEFAULT_BUFFERED_PROCESS_TIMEOUT_MS',
            'MAX_BUFFERED_PROCESS_MAX_BYTES',
            'MAX_BUFFERED_PROCESS_TIMEOUT_MS',
            'executeBufferedProcess',
        ],
    }),
    definePublicApi({
        alias: '#copilot/infra/public/process/supervision',
        target: './src/copilot/infra/public/process/supervision/index.js',
        audience: 'runtime',
        privilege: 'authority',
        stability: 'stable',
        lifecycle: 'none',
