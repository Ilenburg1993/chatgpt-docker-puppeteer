...
| 88    | `88-BLOCO-K-W86.8-CHECKPOINT-DIALOG-BOOT-LIFECYCLE-SEAM.md`            | checkpoint da extração do boot lifecycle e circuit breaker do dialog loop para seams dedicados          |
| 89    | `89-BLOCO-K-W87.1-CHECKPOINT-AGENT-LIFECYCLE-CORE-RUNTIME-PORT.md`     | checkpoint inicial da W87 reduzindo imports diretos de core no lifecycle via porta agent-local          |
