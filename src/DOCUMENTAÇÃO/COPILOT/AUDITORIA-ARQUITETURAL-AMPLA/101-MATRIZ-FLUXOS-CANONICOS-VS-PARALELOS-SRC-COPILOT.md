...
**Data:** 2026-05-01
**Objetivo:** classificar todas as rotas de execução por criticidade de convergência para o canônico.
...
**Meta 2.1:** reduzir os paralelos `PR` para zero e manter apenas `PC` estritamente necessários, com sunset explícito.
