...
// Core remains temporarily only for generic error helpers during Phase I.

vi.mock('#copilot/infra/public/platform/network', async (importOriginal) => {
    const actual = /** @type {Record<string, unknown>} */ (await importOriginal());
    return { ...actual, fetchPublicHttp: mocks.fetchPublicHttp };
});
...
describe('web-tools', () => {
    ...
    beforeEach(() => {
        ...
        fetchSpy = mocks.fetchPublicHttp;
