// @ts-check
/**
 * Sprint 10 — Testes unitários de src/copilot/lib/client.js
 *
...
describe('lib/client › buildClientOptions', () => {
    afterEach(() => {
    ...
    it('retorna objeto vazio quando COPILOT_CLI_URL nao definida', async () => {
        delete process.env.COPILOT_CLI_URL;
        const { buildClientOptions } = await import('../../../src/copilot/lib/client.js');
...
describe('lib/client › getClientState', () => {
...
describe('lib/client › getClientSession', () => {
    it('retorna undefined para ID inexistente', async () => {
        const { getClientSession } = await import('../../../src/copilot/lib/client.js');
        assert.strictEqual(getClientSession('nao-existe-abc123'), undefined);
    });
});

describe('lib/client › listActiveClientSessions', () => {
    it('retorna array', async () => {
        const { listActiveClientSessions } = await import('../../../src/copilot/lib/client.js');
...
describe('lib/client › disconnectClientSession', () => {
    it('nao lanca erro para sessao inexistente', async () => {
        const { disconnectClientSession } = await import('../../../src/copilot/lib/client.js');
        await assert.doesNotReject(() => disconnectClientSession('nao-existe-xyz'));
    });
});

describe('lib/client › incrementSessionMessageCount', () => {
    it('nao lanca erro para sessao inexistente', async () => {
        const { incrementSessionMessageCount } = await import('../../../src/copilot/lib/client.js');
