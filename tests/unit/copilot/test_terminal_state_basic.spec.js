 ...
 *
 * Contrato: presentation/runtime-ui-state-store.js
 */

import { describe, expect, it } from 'vitest';
describe('presentation/runtime-ui-state-store.js — contrato', () => {
    it('importa sem erros', async () => {
        const mod = await import('../../../src/copilot/presentation/runtime-ui-state-store.js');
