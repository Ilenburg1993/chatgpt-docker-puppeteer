...
describe('MCP 2026 modern HTTP protocol', () => {
    it('negotiates 2026-07-28 and preserves the canonical 84-tool surface in memory', async () => {
        ...
        try {
            ...
            assert.equal(wireTools.tools.length, 84);
            assert.equal(expectedNames.size, 84);
