...
describe('Migrator V4 → V5', () => {
    ...
    describe('Migração em batch', () => {
        ...
        it('deve lidar com mix de V4 e V5 em batch', () => {
            const tasksMix = [
                {
                    meta: { id: 'mix-v4', version: '4.0', created_at: new Date().toISOString(), priority: 5, source: 'api' },
                ...
                {
                    meta: { id: 'mix-v5', version: '5.0', created_at: new Date().toISOString(), priority: 5, source: 'api' },
            ...
            assert.ok(resultado.every(t => t.meta.version === '5.0'), 'Todas devem ser V5');
        });
    });
