...
**Propósito**: Dados estáticos de fixtures usados nos testes — configurações, identidades, respostas, tarefas e exemplos para MCP e RAG.  
**Status**: Canônico.  
...
- Fixtures compartilhados por múltiplos suítes ficam aqui; fixtures específicos ficam junto ao teste.
