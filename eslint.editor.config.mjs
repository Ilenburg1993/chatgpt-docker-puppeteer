 ...
 * typescript-eslint's projectService to build another TypeScript semantic graph, duplicating the editor language
 * service and retaining roughly a gigabyte on this repository. The editor needs fast structural feedback; semantic
 * correctness remains enforced by the canonical lint/typecheck gates.
 *
...
export default tseslint.config(...canonicalConfig, {
