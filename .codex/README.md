...
- If you already logged in using the default home (`~/.codex`), you may need to login again for this home, or copy `~/.codex/auth.json` → `.codex/auth.json` (this repo ignores `.codex/*` except `config.toml` and this README).
