...
description:
  ...
  version-specific behavior, migration guides, or official usage examples. Prioritize Context7 MCP
  before generic web search and declare explicit fallback when Context7 is unavailable.
---
