...
/**
 * @file Proxy de compatibilidade para healthcheck.js
 * @deprecated Este script foi movido para scripts/health/healthcheck.js Este arquivo é um proxy temporário para manter
 *   compatibilidade.
 */
