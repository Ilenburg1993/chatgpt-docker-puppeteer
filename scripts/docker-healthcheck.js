 ...
 * @description Healthcheck script para uso no HEALTHCHECK do Dockerfile de produção.
 *
 * Verifica se o servidor HTTP está respondendo na porta configurada (default: 3008).
 * Retorna exit code 0 se saudável, 1 caso contrário.
 *
 * Uso no Dockerfile:
