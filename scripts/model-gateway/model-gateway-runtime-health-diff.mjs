...
if (argSet.has('--help') || argSet.has('-h')) {
    process.stdout.write(`Usage: node scripts/model-gateway/model-gateway-runtime-health-diff.mjs [--json] [--baseline FILE] [--write-snapshot] [--out-dir DIR] [--fail-on-regression]
