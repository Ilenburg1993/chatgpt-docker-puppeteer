...
Options:
  ...
  --sdk-confirmation-max-rows=<n>      SDK session confirmation rows to keep.
...
const policy = {
    ...
    sdkSessionConfirmationMaxRows: numberFor(
