...
Objetivo
--------
Criar documentação técnica abrangente para o repositório `chatgpt-docker-puppeteer`, cobrindo arquitetura, subsistemas, runbooks e políticas de autonomia para permitir manutenção, operação e onboarding.
...
- `DOCUMENTAÇÃO/NERV.md`, `DOCUMENTAÇÃO/KERNEL.md`, `DOCUMENTAÇÃO/DRIVER.md`, `DOCUMENTAÇÃO/INFRA.md`, `DOCUMENTAÇÃO/SERVER.md`, `DOCUMENTAÇÃO/CORE.md`
...
Notas finais
-----------
Este documento define escopo inicial e regras para automações seguras. Podemos ajustar prioridades e regras conforme preferir.
