...
- Instruções permanentes para o assistente de IA sobre o projeto.
- Inventário de arquivos `src/` e notas de performance para contexto.
...
- Instruções permanentes de agente → `.github/instructions/`.
- Skills especializadas → `.github/skills/`.

## Links relacionados

- Instruções permanentes: `.github/instructions/`
- Skills: `.github/skills/`
- Documentação canônica: `DOCUMENTAÇÃO/`
