...
Objetivo
- Evoluir o projeto para tipagem 100% e profissional, com gate automático (CI/local) e sem regressões de runtime.
...
Notas
- O dashboard (`src/dashboard-ui`) fica fora do escopo inicial. Depois a gente cria um plano separado para tipagem do front.
