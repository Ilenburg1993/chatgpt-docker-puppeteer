...
## Nota
Este baseline é registrado para rastreabilidade. O upgrade do dashboard (UI + server) não tem como objetivo corrigir, nesta etapa, o backlog de formatação global nem falhas de testes não relacionadas.
