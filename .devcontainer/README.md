...
Desenvolvedores usando VS Code Remote Containers ou GitHub Codespaces. **Última atualização**: 7 de
março de 2026.
...
| ------------------------------ | -------------------------------------------------- |
| `devcontainer.json`            | Configuração principal do DevContainer (v5.4.0)    |
