...
Este documento é a **fonte única de verdade** sobre a topologia de portas do sistema. Descreve onde cada serviço roda, quais portas usa e como os componentes se comunicam.
...
**Localização**: DevContainer (PM2)
**Bind**: `0.0.0.0:9224`
**Acesso Puppeteer**: `localhost:9224`
...
**Localização**: Windows Host
**Bind**: `0.0.0.0:9225`
**Acesso Proxy**: `host.docker.internal:9225`
...
Docker Desktop (WSL2 backend) fornece o DNS especial `host.docker.internal` que resolve para o IP do Windows visível ao container.
...
A porta 9224 também não deve ser exposta via VS Code Port Forwarding ou outras ferramentas. Ela é uma fronteira arquitetural interna.
