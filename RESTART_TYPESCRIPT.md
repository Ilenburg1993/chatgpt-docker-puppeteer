...
✅ **TS2769** - "No overload matches this call" (schemas com Object.freeze)
✅ **TS2345** - "Argument of type 'this' is not assignable" (BaseDriver)
✅ **TS2339** - "Property does not exist" (Error.details, config properties, etc.)
✅ **TS2322** - Type mismatches (propriedades dinâmicas)
