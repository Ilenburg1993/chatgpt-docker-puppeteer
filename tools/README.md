...
**Propósito**: Ferramentas auxiliares externas ao runtime do produto — RAG, MCP, Ollama, análise de projeto e geração de skills.  
...
- Tooling auxiliar que suporta desenvolvimento, auditoria e operações, mas não faz parte do runtime `src/`.
